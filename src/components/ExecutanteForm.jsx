...
const ExecutanteForm = ({ onSubmit, onCancel, initialData }) => {
  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader>
        <CardTitle>{initialData ? 'Editar Executante' : 'Novo Cadastro de Executante'}</CardTitle>
      </CardHeader>
      <CardContent>
