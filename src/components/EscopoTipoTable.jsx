...
const EscopoTipoTable = ({ escopoTipos, onEdit, onDelete, onAddNew }) => {
  const [filterText, setFilterText] = useState('');
  const [sortAscending, setSortAscending] = useState(true);

  const filteredEscopoTipos = escopoTipos.filter(escopo => 
  ...
  return (
    <div className="space-y-4">
      ...
      <Table>
        ...
        <TableBody>
          {filteredEscopoTipos.map((escopo) => (
...
export default EscopoTipoTable;