...
const EscopoOrigemForm = ({ onSubmit, onCancel, initialData }) => {
  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader>
        <CardTitle>{initialData ? 'Editar Escopo Origem' : 'Novo Cadastro de Escopo Origem'}</CardTitle>
      </CardHeader>
      <CardContent>
...
export default EscopoOrigemForm;